	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'soft-glow': 'radial-gradient(circle at center, rgba(255, 255, 255, 0.8), transparent 70%)',
			},
			boxShadow: {
				'glass': '0 8px 32px 0 rgba(31, 38, 135, 0.07)',
				'neu-light': '20px 20px 60px #d9d9d9, -20px -20px 60px #ffffff',
				'neu-dark': '20px 20px 60px rgba(0, 0, 0, 0.1), -20px -20px 60px rgba(255, 255, 255, 0.05)',
			},
			backdropFilter: {
				'glass': 'blur(4px)',
			},
